...
def mamadisima_evaluation_function1(state: TwoPlayerGameState) -> float:
    ...
    if (((not state.is_player_max(state.next_player)) and state.next_player.label=='W') or (state.is_player_max(state.next_player) and state.next_player.label!='W')):
        return -state_value

    return state_value

def mamadisima_evaluation_function2(state: TwoPlayerGameState) -> float:
    """Devuelve un valor dado por la ponderación de varios aspectos que afectan al juego. 
       En particular pondera: """
...
def mamadisima_evaluation_function3(state: TwoPlayerGameState) -> float:
    """Devuelve un valor dado por la ponderación de varios aspectos que afectan al juego. 
       En particular pondera: """
...
def mamadisima_evaluation_function4(state: TwoPlayerGameState) -> float:
    """Devuelve un valor dado por la ponderación de varios aspectos que afectan al juego. 
       En particular pondera: """
...
heuristica_mamadisima1 = Heuristic(
    name='Heuristic mamadisima1',
    evaluation_function = mamadisima_evaluation_function1,
)

heuristica_mamadisima2 = Heuristic(
    name='Heuristic mamadisima2',
    evaluation_function = mamadisima_evaluation_function2,
)

heuristica_mamadisima3 = Heuristic(
    name='Heuristic mamadisima3',
    evaluation_function = mamadisima_evaluation_function3,
)

heuristica_mamadisima4 = Heuristic(
    name='Heuristic mamadisima4',
    evaluation_function = mamadisima_evaluation_function4,
)
